                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                <div class="text-center">
                                    ...
                                    <h1 class="h4 text-info mb-4">Pembayaran Listrik</h1>
                                </div>
                                <hr>
                                ...
                                <hr>
                                <div class="text-center">
                                    <a class="small text-info" href="<?= base_url('auth/registrasi'); ?>">Buat Akun!</a>
                                </div>
                                <div class="text-center">
                                    <a class="small text-info" href="<?= base_url('menu_utama'); ?>">Halaman Utama</a>
                                </div>
